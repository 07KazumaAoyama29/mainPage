...
urlpatterns = [
    ...
    path("daily-routines/create/", views.daily_routine_create, name="daily_routine_create"),
    path("daily-routines/<int:pk>/update/", views.daily_routine_update, name="daily_routine_update"),
    path("daily-routines/<int:pk>/delete/", views.daily_routine_delete, name="daily_routine_delete"),
